 ...
 */
class GenerateServerCommand extends ContainerAwareCommand
{
    private $generator;
    ...
    {
        $this
            ->setName('mock:bundle:generate')
            ->setDescription('Generates a mock server bundle')
            ->setDefinition(array(
    ...
    {
        $dialog = $this->getDialogHelper();
        $dialog->writeSection($output, 'Welcome to the MockServer bundle generator');
    ...
    public function setGenerator(BundleManager $generator)
    {
